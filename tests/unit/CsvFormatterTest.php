...
class CsvFormatterTest extends TestCase
{
    ...
    public function test_puts_fields_between_commata()
    {
    ...
    public function test_puts_string_with_comma_inside_quotes()
    {
        $sut = new CsvFormatter();
    ...
    public function test_doubles_quote_inside_string()
    {
        $sut = new CsvFormatter();
        $actual = $sut->format([[1, 'kaas",appel', 3]]);
        $this->assertSame('1,"kaas"",appel",3'.PHP_EOL, $actual);
